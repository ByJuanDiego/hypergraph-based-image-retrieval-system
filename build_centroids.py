...
from graph.distances import weighted_distance, euclidean_distance, manhattan_distance, cosine_score, best_of_the_best_distance
...
def build_centroids(distance_fn, save_centroids_path, filename, threshold, cache):
    ...
    print("------------------------- start -------------------------")
    mean_shift.fit_leader_algorithm()
...
print("-------------- best distance -------------")
build_centroids(best_of_the_best_distance, save_path, "best_distance_1.5.p", T, None)
